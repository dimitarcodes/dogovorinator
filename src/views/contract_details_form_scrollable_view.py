...
class ContractDetailsFormScrollableView(AbstractView):
    ...
    def _build_gui(self):
        # Title
        self.title_label = QLabel("Въведете данни за договора (Разширена форма):")
        title_font = QFont()
        ...
        self.personal_info_frame.setLayout(personal_layout)
        ...
        personal_layout.addRow("Име на служител:", self.employee_name_edit)
        personal_layout.addRow("ЕГН:", self.employee_egn_edit)
        personal_layout.addRow("Лична карта №:", self.employee_id_card_edit)
        personal_layout.addRow("Телефон:", self.employee_phone_edit)
        personal_layout.addRow("Email:", self.employee_email_edit)
        personal_layout.addRow("Адрес:", self.employee_address_edit)
        personal_layout.addRow("Дата на раждане:", self.birth_date_edit)
        personal_layout.addRow("Място на раждане:", self.birth_place_edit)
        ...
        scroll_layout.addWidget(self.personal_info_frame)
    ...
    def _go_next(self):
        ...
        self.employee_data = {
            ...
            'id_card': self.employee_id_card_edit.text().strip(),
            'phone': self.employee_phone_edit.text().strip(),
            'email': self.employee_email_edit.text().strip(),
            'address': self.employee_address_edit.toPlainText().strip(),
